...
const Sidebar = ({ isOpen }) => {
  ...
  return isOpen
    ? createPortal(
        <>
          <div className="fixed top-0 p-2 pt-6 align-middle justify-center left-0 h-full bg-[--white-bg] w-[225px] shadow-lg shadow-slate-400 dark:shadow-black dark:bg-[--dd-blue-bg] ease-in-out transition-all duration-500">
